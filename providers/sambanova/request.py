...
SAMBANOVA_DEFAULT_MAX_TOKENS = 81920


def build_request_body(request_data: Any) -> dict:
    """Build OpenAI-format request body from Anthropic request for Sambanova."""
    logger.debug(
    ...
    body = build_base_request_body(
        request_data,
        default_max_tokens=SAMBANOVA_DEFAULT_MAX_TOKENS,
    )
